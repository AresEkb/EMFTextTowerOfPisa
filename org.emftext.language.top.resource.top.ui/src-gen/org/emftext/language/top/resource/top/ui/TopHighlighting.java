 ...
 */
public class TopHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.top.resource.top.ui.TopPositionHelper positionHelper = new org.emftext.language.top.resource.top.ui.TopPositionHelper();
	...
	private org.emftext.language.top.resource.top.ui.TopTokenScanner scanner;
	...
	private org.emftext.language.top.resource.top.ui.TopEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.top.resource.top.ui.TopOccurrence occurrence;
	private org.emftext.language.top.resource.top.ui.TopBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.top.resource.top.ITopBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public TopHighlighting(org.emftext.language.top.resource.top.ITopTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.top.resource.top.ui.TopColorManager colorManager, org.emftext.language.top.resource.top.ui.TopEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.top.resource.top.ui.TopUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.top.resource.top.ui.TopTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.top.resource.top.ui.TopOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.top.resource.top.ui.TopBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.top.resource.top.ui.TopPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.top.resource.top.ui.TopPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.top.resource.top.ui.TopEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.top.resource.top.ui.TopPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.top.resource.top.ui.TopEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
