 ...
 */
public class TopUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.top.resource.top.ui";
	public static final String EDITOR_ID = "org.emftext.language.top.resource.top.ui.TopEditor";
	...
	private static TopUIPlugin plugin;
	...
	public static TopUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TopUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TopUIPlugin.PLUGIN_ID, message);
		}
		final TopUIPlugin pluginInstance = TopUIPlugin.getDefault();
