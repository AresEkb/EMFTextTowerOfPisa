 ...
 */
public class TopPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.top.resource.top.ui.TopUIPlugin.getDefault().getPreferenceStore());
		setDescription("Top Text Editor Preferences");
	}
