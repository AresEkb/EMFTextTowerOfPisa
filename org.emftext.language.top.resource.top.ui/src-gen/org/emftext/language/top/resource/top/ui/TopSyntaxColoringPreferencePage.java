 ...
 */
public class TopSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public TopSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.top.resource.top.mopp.TopMetaInformation metaInformation = new org.emftext.language.top.resource.top.mopp.TopMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.top.resource.top.ui.TopSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.top.resource.top.ui.TopPixelConverter pixelConverter = new org.emftext.language.top.resource.top.ui.TopPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.top.resource.top.ui.TopEditor) {
			org.emftext.language.top.resource.top.ui.TopEditor emfTextEditor = (org.emftext.language.top.resource.top.ui.TopEditor) editor;
