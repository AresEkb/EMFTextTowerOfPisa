...
public class TopBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.top.resource.top.ITopBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.top.resource.top.ITopBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.top.resource.top.ui.ITopBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.top.resource.top.ITopBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public TopBracketSet(org.emftext.language.top.resource.top.ui.TopEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.top.resource.top.mopp.TopMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.top.resource.top.ITopBracketPair>();
	 ...
	 */
	public org.emftext.language.top.resource.top.ITopBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.top.resource.top.ITopBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.top.resource.top.ITopBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.top.resource.top.ITopBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.top.resource.top.ui.TopPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.top.resource.top.ITopBracketPair remove(String opening, String closing) {
		for (org.emftext.language.top.resource.top.ITopBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.top.resource.top.ITopBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
