 ...
 * a specified depth.
 */
public class TopOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public TopOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.top.resource.top.util.TopStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.top.resource.top.ui.TopEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.top.resource.top.mopp.TopPlugin.logError("Exception while refreshing outline view", e);
		}
	}
