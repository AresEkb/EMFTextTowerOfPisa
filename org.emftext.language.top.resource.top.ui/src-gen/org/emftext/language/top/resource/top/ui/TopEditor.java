...
/**
 * A text editor for 'top' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.top.resource.top.ui.TopEditor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.top.resource.top.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.top.resource.top.EditorRuler</code>.
 * </p>
 */
public class TopEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.top.resource.top.ITopResourceProvider, org.emftext.language.top.resource.top.ui.ITopBracketHandlerProvider, org.emftext.language.top.resource.top.ui.ITopAnnotationModelProvider {
	
	private org.emftext.language.top.resource.top.ui.TopHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.top.resource.top.ui.TopCodeFoldingManager codeFoldingManager;
	private org.emftext.language.top.resource.top.ui.TopBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.top.resource.top.ui.TopBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.top.resource.top.ITopBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.top.resource.top.ITopBackgroundParsingListener>();
	private org.emftext.language.top.resource.top.ui.TopColorManager colorManager = new org.emftext.language.top.resource.top.ui.TopColorManager();
	private org.emftext.language.top.resource.top.ui.TopOutlinePage outlinePage;
	...
	private org.emftext.language.top.resource.top.ui.TopPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.top.resource.top.ui.ITopBracketHandler bracketHandler;
	...
	public TopEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.top.resource.top.ui.TopSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), TopEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.top.resource.top.ITopTextResource currentResource = getResource();
				...
				org.emftext.language.top.resource.top.ui.TopUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.top.resource.top.EditorContext");
		setRulerContextMenuId("org.emftext.language.top.resource.top.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.top.resource.top.ui.TopHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.top.resource.top.ui.TopCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.top.resource.top.mopp.TopNature.activate(inputFile.getProject());
		...
		org.emftext.language.top.resource.top.ITopTextResource loadedResource = (org.emftext.language.top.resource.top.ITopTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.top.resource.top.ITopTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.top.resource.top.ITopTextResource) {
					setResource((org.emftext.language.top.resource.top.ITopTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.top.resource.top.ui.TopUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the TopEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.top.resource.top.ui.TopUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.top.resource.top.ITopTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.top.resource.top.ui.TopOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.top.resource.top.ui.TopPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.top.resource.top.ITopTextResource textResource = (org.emftext.language.top.resource.top.ITopTextResource) element.eResource();
			org.emftext.language.top.resource.top.ITopLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.top.resource.top.ITopTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.top.resource.top.ITopTextToken token = lexer.getNextToken();
			...
			org.emftext.language.top.resource.top.ui.TopUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!TopEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.top.resource.top.ITopBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.top.resource.top.ITopBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.top.resource.top.ui.ITopBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.top.resource.top.ui.ITopBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.top.resource.top.ITopTextResource)) {
					return false;
				}
				org.emftext.language.top.resource.top.ITopTextResource textResource = (org.emftext.language.top.resource.top.ITopTextResource) resource;
				org.emftext.language.top.resource.top.ITopLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
