 ...
 */
public class TopIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.top.resource.top.grammar.TopGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
