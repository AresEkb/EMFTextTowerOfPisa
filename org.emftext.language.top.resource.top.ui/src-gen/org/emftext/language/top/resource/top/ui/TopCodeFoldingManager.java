 ...
 */
public class TopCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.top.resource.top.ITopBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.top.resource.top.ui.TopEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.top.resource.top.ui.TopEditor) {
				org.emftext.language.top.resource.top.ui.TopEditor editor = (org.emftext.language.top.resource.top.ui.TopEditor) workbenchPart;
	...
	protected org.emftext.language.top.resource.top.ui.TopEditor editor;
	 ...
	 */
	public TopCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.top.resource.top.ui.TopEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.top.resource.top.ui.TopEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.top.resource.top.ui.TopUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.top.resource.top.ITopTextResource textResource = (org.emftext.language.top.resource.top.ITopTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
