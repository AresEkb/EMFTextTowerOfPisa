 ...
 */
public class TopNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TopNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new top file");
