 ...
 */
public class TopNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.top.resource.top.mopp.TopMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.top.resource.top.ui");
							...
							String natureID = org.emftext.language.top.resource.top.mopp.TopNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.top.resource.top.mopp.TopNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.top.resource.top.mopp.TopMetaInformation info = new org.emftext.language.top.resource.top.mopp.TopMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.top.resource.top.ui.TopUIPlugin.getDefault().getBundle();
