 ...
 */
public class TopCompletionProposal implements java.lang.Comparable<TopCompletionProposal> {
	 ...
	 */
	private org.emftext.language.top.resource.top.mopp.TopExpectedTerminal expectedTerminal;
	...
	public TopCompletionProposal(org.emftext.language.top.resource.top.mopp.TopExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public TopCompletionProposal(org.emftext.language.top.resource.top.mopp.TopExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public TopCompletionProposal(org.emftext.language.top.resource.top.mopp.TopExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public org.emftext.language.top.resource.top.mopp.TopExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof TopCompletionProposal) {
			TopCompletionProposal other = (TopCompletionProposal) object;
	...
	public int compareTo(TopCompletionProposal object) {
		if (object instanceof TopCompletionProposal) {
			TopCompletionProposal other = (TopCompletionProposal) object;
