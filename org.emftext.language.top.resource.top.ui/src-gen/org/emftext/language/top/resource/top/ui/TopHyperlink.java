 ...
 */
public class TopHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TopHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.top.resource.top.mopp.TopPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
