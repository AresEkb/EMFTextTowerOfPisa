 ...
 */
public class TopTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.top.resource.top.ITopHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.top.resource.top.ui.TopBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.top.resource.top.ui.TopBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput infoInput = (org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.top.resource.top.ui.TopHyperlink hyperlink = new org.emftext.language.top.resource.top.ui.TopHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.top.resource.top.ui.TopBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.top.resource.top.ui.TopBrowserInformationControl iControl = new org.emftext.language.top.resource.top.ui.TopBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput) {
							org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput input = (org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.top.resource.top.ui.TopBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.top.resource.top.ui.TopBrowserInformationControl iControl = new org.emftext.language.top.resource.top.ui.TopBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public TopTextHover(org.emftext.language.top.resource.top.ITopResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.top.resource.top.ui.TopUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.top.resource.top.ITopTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.top.resource.top.ui.TopHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.top.resource.top.ui.TopHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.top.resource.top.ui.TopHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.top.resource.top.ui.TopTextHover.getStyleSheet());
			org.emftext.language.top.resource.top.ui.TopHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.top.resource.top.ui.TopHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.top.resource.top.ui.TopUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.top.resource.top.util.TopStreamUtil.getContent(styleSheetURL.openStream());
