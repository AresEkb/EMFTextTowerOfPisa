 ...
 */
public class TopLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.top.resource.top.mopp.TopMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.top.resource.top.launch.TopLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.top.resource.top.mopp.TopPlugin.logError("Exception while launching selection", e);
		}
	}
