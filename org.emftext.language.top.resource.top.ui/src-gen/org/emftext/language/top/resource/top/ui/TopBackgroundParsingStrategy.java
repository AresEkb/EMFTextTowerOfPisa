 ...
 */
public class TopBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.top.resource.top.ITopTextResource resource, final org.emftext.language.top.resource.top.ui.TopEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.top.resource.top.ITopTextResource resource, final org.emftext.language.top.resource.top.ui.TopEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.top.resource.top.ITopTextResource resource, final org.emftext.language.top.resource.top.ui.TopEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.top.resource.top.mopp.TopResource) {
							org.emftext.language.top.resource.top.mopp.TopResource concreteResource = (org.emftext.language.top.resource.top.mopp.TopResource) resource;
