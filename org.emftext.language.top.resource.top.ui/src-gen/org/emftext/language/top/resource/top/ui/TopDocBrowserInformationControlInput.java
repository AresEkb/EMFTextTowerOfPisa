 ...
 * olInput</code>.
 */
public class TopDocBrowserInformationControlInput {
	
	private final TopDocBrowserInformationControlInput fPrevious;
	private TopDocBrowserInformationControlInput fNext;
	 ...
	 */
	public TopDocBrowserInformationControlInput(TopDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public TopDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public TopDocBrowserInformationControlInput getNext() {
		return fNext;
	}
