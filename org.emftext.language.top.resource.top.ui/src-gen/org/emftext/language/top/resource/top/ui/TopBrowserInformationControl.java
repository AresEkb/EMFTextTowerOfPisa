 ...
 * @since 3.2
 */
public class TopBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput fInput;
	 ...
	 */
	public TopBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public TopBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public TopBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput) input;
		...
		org.emftext.language.top.resource.top.ui.TopHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.top.resource.top.ui.TopHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.top.resource.top.ui.TopDocBrowserInformationControlInput getInput() {
		return fInput;
	}
