...
public class TopOccurrence {
	...
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.top.resource.top.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.top.resource.top.ui.occurences.declaration";
	...
	private org.emftext.language.top.resource.top.ui.TopTokenScanner tokenScanner;
	...
	private org.emftext.language.top.resource.top.ITopTextResource textResource;
	 ...
	 */
	public TopOccurrence(org.emftext.language.top.resource.top.ITopTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.top.resource.top.ui.TopTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.top.resource.top.mopp.TopMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.top.resource.top.ui.TopBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.language.top.resource.top.ui.TopPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.language.top.resource.top.ui.TopPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.language.top.resource.top.ui.TopPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.language.top.resource.top.ui.TopOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.top.resource.top.ui.TopOccurrence.DECLARATION_ANNOTATION_ID);
	}
