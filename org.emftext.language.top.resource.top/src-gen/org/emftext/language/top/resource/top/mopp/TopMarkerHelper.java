 ...
 * contains <code>org.emftext.language.top.resource.top.ITopTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class TopMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.top.resource.top.mopp.TopPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.top.resource.top.ITopCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.top.resource.top.ITopCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.language.top.resource.top.ITopCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.language.top.resource.top.ITopCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.top.resource.top.ITopCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.language.top.resource.top.ITopCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.top.resource.top.ITopTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.top.resource.top.ITopTextDiagnostic diagnostic) {
		final org.emftext.language.top.resource.top.ITopProblem problem = diagnostic.getProblem();
		org.emftext.language.top.resource.top.TopEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.top.resource.top.ITopCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.top.resource.top.TopEProblemSeverity.ERROR) {
					...
					org.emftext.language.top.resource.top.ITopTextDiagnostic textDiagnostic = (org.emftext.language.top.resource.top.ITopTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.top.resource.top.mopp.TopResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.top.resource.top.mopp.TopResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.top.resource.top.ITopQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.top.resource.top.util.TopStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.top.resource.top.TopEProblemType nextType : org.emftext.language.top.resource.top.TopEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.top.resource.top.TopEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.top.resource.top.TopEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.language.top.resource.top.TopEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.top.resource.top.util.TopRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.top.resource.top.ITopCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.top.resource.top.mopp.TopPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
