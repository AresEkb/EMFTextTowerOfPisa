...
public class TopLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.emftext.language.top.resource.top.mopp.TopLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.emftext.language.top.resource.top.mopp.TopLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.emftext.language.top.resource.top.mopp.TopLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.emftext.language.top.resource.top.mopp.TopLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.emftext.language.top.resource.top.grammar.TopSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.emftext.language.top.resource.top.grammar.TopGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.emftext.language.top.resource.top.mopp.TopLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.emftext.language.top.resource.top.grammar.TopSyntaxElement syntaxElement = org.emftext.language.top.resource.top.grammar.TopGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.emftext.language.top.resource.top.grammar.TopPlaceholder) {
			org.emftext.language.top.resource.top.grammar.TopPlaceholder placeholder = (org.emftext.language.top.resource.top.grammar.TopPlaceholder) syntaxElement;
			org.emftext.language.top.resource.top.ITopTokenResolver tokenResolver = new org.emftext.language.top.resource.top.mopp.TopTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.emftext.language.top.resource.top.ITopTokenResolveResult result = new org.emftext.language.top.resource.top.mopp.TopTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.emftext.language.top.resource.top.mopp.TopLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.emftext.language.top.resource.top.mopp.TopLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
