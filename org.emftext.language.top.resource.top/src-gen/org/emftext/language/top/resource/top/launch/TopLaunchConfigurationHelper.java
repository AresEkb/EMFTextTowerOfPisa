 ...
 * delegates.
 */
public class TopLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.emftext.language.top.resource.top.util.AbstractTopInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.emftext.language.top.resource.top.util.AbstractTopInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.emftext.language.top.resource.top.debug.TopDebuggableInterpreter<ResultType, ContextType> interpreter = new org.emftext.language.top.resource.top.debug.TopDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.emftext.language.top.resource.top.debug.TopDebuggerListener<ResultType, ContextType> debugListener = new org.emftext.language.top.resource.top.debug.TopDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.emftext.language.top.resource.top.debug.TopDebugProcess process = new org.emftext.language.top.resource.top.debug.TopDebugProcess(launch);
		launch.addDebugTarget(new org.emftext.language.top.resource.top.debug.TopDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.emftext.language.top.resource.top.launch.TopLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.emftext.language.top.resource.top.util.TopResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.top.resource.top.mopp.TopPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
