...
/**
 * A TopLayoutInformationAdapter is used to store layout information that is found
 ...
 * TopLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class TopLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.top.resource.top.mopp.TopLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.top.resource.top.mopp.TopLayoutInformation>();
	...
	public java.util.List<org.emftext.language.top.resource.top.mopp.TopLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.top.resource.top.mopp.TopLayoutInformation layoutInformation) {
