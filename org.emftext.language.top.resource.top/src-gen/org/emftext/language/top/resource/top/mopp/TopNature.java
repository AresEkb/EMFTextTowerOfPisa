...
public class TopNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.top.resource.top.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.top.resource.top.mopp.TopBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.top.resource.top.mopp.TopBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
