 ...
 */
public class TopDefaultTokenResolver implements org.emftext.language.top.resource.top.ITopTokenResolver {
	 ...
	 */
	public TopDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public TopDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.top.resource.top.ITopTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.top.resource.top.ITopTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.top.resource.top.grammar.TopGrammarInformationProvider.INSTANCE.getKeywords()) {
