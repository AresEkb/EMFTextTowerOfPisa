 ...
 */
public class TopPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.top.resource.top";
	/**
	...
	private static TopPlugin plugin;
	...
	public static TopPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, TopPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, TopPlugin.PLUGIN_ID, message);
		}
		final TopPlugin pluginInstance = TopPlugin.getDefault();
