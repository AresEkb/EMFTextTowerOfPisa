...
public class TopResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.emftext.language.top.resource.top.util.TopInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.emftext.language.top.resource.top.util.TopInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.emftext.language.top.resource.top.mopp.TopResource getResource(java.io.File file) {
	...
	public static org.emftext.language.top.resource.top.mopp.TopResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.emftext.language.top.resource.top.mopp.TopMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.emftext.language.top.resource.top.mopp.TopResource) resource;
	}
	 ...
	 */
	public static org.emftext.language.top.Expr getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.top.Expr getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.emftext.language.top.Expr) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.emftext.language.top.Expr getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.emftext.language.top.resource.top.ITopTextResource resource = (org.emftext.language.top.resource.top.ITopTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.emftext.language.top.resource.top.ITopTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.emftext.language.top.resource.top.ITopTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
